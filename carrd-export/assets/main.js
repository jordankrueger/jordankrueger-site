							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'About',
										'page_location': 'https://jordankrueger.com/#about',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Projects',
										'page_location': 'https://jordankrueger.com/#projects',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Contact',
										'page_location': 'https://jordankrueger.com/#contact',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Home',
										'page_location': 'https://jordankrueger.com',
									});
								},
							],
						},
